...
def cwevent_event_dtype():
    ...
    extended_headers = [
        ('HOME_TEAM_ID', 'a8'), ('BAT_TEAM_ID', 'a8'), ('FLD_TEAM_ID', 'a8'),
        ('BAT_LAST_ID', 'a8'), ('INN_NEW_FL', 'a8'), ('INN_END_FL', 'a8'),
        ('START_BAT_SCORE_CT', 'a8'), ('START_FLD_SCORE_CT', 'a8'),
        ('INN_RUNS_CT', 'a8'), ('GAME_PA_CT', 'a8'), ('INN_PA_CT', 'a8'),
        ('PA_NEW_FL', 'a8'), ('PA_TRUNC_FL', 'a8'), ('START_BASES_CD', 'a8'),
        ('END_BASES_CD', 'a8'), ('BAT_START_FL', 'a8'),
        ('RESP_BAT_START_FL', 'a8'), ('BAT_ON_DECK_ID', 'a8'),
        ('BAT_IN_HOLD_ID', 'a8'), ('PIT_START_FL', 'a8'),
        ('RESP_PIT_START_FL', 'a8'), ('RUN1_FLD_CD', 'a8'),
        ('RUN1_LINEUP_CD', 'a8'), ('RUN1_ORIGIN_EVENT_ID', 'a8'),
        ('RUN2_FLD_CD', 'a8'), ('RUN2_LINEUP_CD', 'a8'),
        ('RUN2_ORIGIN_EVENT_ID', 'a8'), ('RUN3_FLD_CD', 'a8'),
        ('RUN3_LINEUP_CD', 'a8'), ('RUN3_ORIGIN_EVENT_ID', 'a8'),
        ('RUN1_RESP_CAT_ID', 'a8'), ('RUN2_RESP_CAT_ID', 'a8'),
        ('RUN3_RESP_CAT_ID', 'a8'), ('PA_BALL_CT', 'a8'),
        ('PA_CALLED_BALL_CT', 'a8'), ('PA_INTENT_BALL_CT', 'a8'),
        ('PA_PITCHOUT_BALL_CT', 'a8'), ('PA_HITBATTER_BALL_CT', 'a8'),
        ('PA_OTHER_BALL_CT', 'a8'), ('PA_STRIKE_CT', 'a8'),
        ('PA_CALLED_STRIKE_CT', 'a8'), ('PA_SWINGMISS_STRIKE_CT', 'a8'),
        ('PA_FOUL_STRIKE_CT', 'a8'), ('PA_INPLAY_STRIKE_CT', 'a8'),
        ('PA_OTHER_STRIKE_CT', 'a8'), ('EVENT_RUNS_CT', 'a8'),
        ('FLD_ID', 'a8'), ('BASE2_FORCE_FL', 'a8'), ('BASE3_FORCE_FL', 'a8'),
        ('BASE4_FORCE_FL', 'a8'), ('BAT_SAFE_ERR_FL', 'a8'),
        ('BAT_FATE_ID', 'a8'), ('RUN1_FATE_ID', 'a8'), ('RUN2_FATE_ID', 'a8'),
        ('RUN3_FATE_ID', 'a8'), ('FATE_RUNS_CT', 'a8'), ('ASS6_FLD_CD', 'a8'),
        ('ASS7_FLD_CD', 'a8'), ('ASS8_FLD_CD', 'a8'), ('ASS9_FLD_CD', 'a8'),
        ('ASS10_FLD_CD', 'a8'), ('UNKNOWN_OUT_EXC_FL', 'a8'),
        ('UNCERTAIN_PLAY_EXC_FL', 'a8'),
    ]
    return np.dtype(standard_headers)
