...
def cwgame_game_dtype():
    standard_headers = [
        ...
        ('GAME_DY', 'a10'), ('START_GAME_TM', 'i4'), ('DH_FL', '?'),
...
def cwevent_dtype():
    ...
    standard_headers = [
        ...
        ('STRIKES_CT', 'i1'), ('PITCH_SEQ_TX', 'a32'),
        ('AWAY_SCORE_CT', 'i1'), ('HOME_SCORE_CT', 'i1'), ('BAT_ID', 'a8'),
        ('BAT_HAND_CD', 'a1'), ('RESP_BAT_ID', 'a8'),
        ('RESP_BAT_HAND_CD', 'a1'), ('PIT_ID', 'a8'), ('PIT_HAND_CD', 'a1'),
        ...
        ('POS8_FLD_ID', 'a8'), ('POS9_FLD_ID', 'a8'), ('BASE1_RUN_ID', 'a8'),
        ('BASE2_RUN_ID', 'a8'), ('BASE3_RUN_ID', 'a8'), ('EVENT_TX', 'a56'),
        ('LEADOFF_FL', '?'), ('PH_FL', '?'), ('BAT_FLD_CD', 'i1'),
        ('BAT_LINEUP_ID', 'i1'), ('EVENT_CD', 'i1'), ('BAT_EVENT_FL', '?'),
        ('AB_FL', '?'), ('H_FL', '?'), ('SH_FL', '?'), ('SF_FL', '?'),
        ('EVENT_OUTS_CT', 'i1'), ('DP_FL', '?'), ('TP_FL', '?'),
        ('RBI_CT', 'i1'), ('WP_FL', '?'), ('PB_FL', '?'), ('FLD_CD', 'i1'),
        ('BATTEDBALL_CD', 'a8'), ('BUNT_FL', '?'), ('FOUL_FL', '?'),
        ('BATTEDBALL_LOC_TX', 'a8'), ('ERR_CT', 'i1'), ('ERR1_FLD_CD', 'i1'),
        ('ERR1_CD', 'a1'), ('ERR2_FLD_CD', 'i1'), ('ERR2_CD', 'a1'),
        ('ERR3_FLD_CD', 'i1'), ('ERR3_CD', 'a1'), ('BAT_DEST_ID', 'i1'),
        ('RUN1_DEST_ID', 'i1'), ('RUN2_DEST_ID', 'i1'), ('RUN3_DEST_ID', 'i1'),
        ('BAT_PLAY_TX', 'a16'), ('RUN1_PLAY_TX', 'a16'),
        ('RUN2_PLAY_TX', 'a16'), ('RUN3_PLAY_TX', 'a16'), ('RUN1_SB_FL', '?'),
        ('RUN2_SB_FL', '?'), ('RUN3_SB_FL', '?'), ('RUN1_CS_FL', '?'),
        ('RUN2_CS_FL', '?'), ('RUN3_CS_FL', '?'), ('RUN1_PK_FL', '?'),
        ('RUN2_PK_FL', '?'), ('RUN3_PK_FL', '?'), ('RUN1_RESP_PIT_ID', 'a8'),
        ('RUN2_RESP_PIT_ID', 'a8'), ('RUN3_RESP_PIT_ID', 'a8'),
        ('GAME_NEW_FL', '?'), ('GAME_END_FL', '?'), ('PR_RUN1_FL', '?'),
        ('PR_RUN2_FL', '?'), ('PR_RUN3_FL', '?'),
        ('REMOVED_FOR_PR_RUN1_ID', 'a8'), ('REMOVED_FOR_PR_RUN2_ID', 'a8'),
        ('REMOVED_FOR_PR_RUN3_ID', 'a8'), ('REMOVED_FOR_PH_BAT_ID', 'a8'),
        ('REMOVED_FOR_PH_BAT_FLD_CD', 'i1'), ('PO1_FLD_CD', 'i1'),
        ('PO2_FLD_CD', 'i1'), ('PO3_FLD_CD', 'i1'), ('ASS1_FLD_CD', 'i1'),
        ('ASS2_FLD_CD', 'i1'), ('ASS3_FLD_CD', 'i1'), ('ASS4_FLD_CD', 'i1'),
        ('ASS5_FLD_CD', 'i1'), ('EVENT_ID', 'i1'),
    ]

    # Extended headers need to be parsed by looking at the column header.
    extended_headers = [
        ('HOME_TEAM_ID', 'a3'), ('BAT_TEAM_ID', 'a3'), ('FLD_TEAM_ID', 'a3'),
        ('BAT_LAST_ID', 'a8'), ('INN_NEW_FL', '?'), ('INN_END_FL', '?'),
        ('START_BAT_SCORE_CT', 'i4'), ('START_FLD_SCORE_CT', 'i4'),
        ('INN_RUNS_CT', 'i4'), ('GAME_PA_CT', 'i4'), ('INN_PA_CT', 'i4'),
        ('PA_NEW_FL', '?'), ('PA_TRUNC_FL', '?'), ('START_BASES_CD', 'a8'),
        ('END_BASES_CD', 'a8'), ('BAT_START_FL', '?'),
        ('RESP_BAT_START_FL', '?'), ('BAT_ON_DECK_ID', 'a8'),
        ('BAT_IN_HOLD_ID', 'a8'), ('PIT_START_FL', '?'),
        ('RESP_PIT_START_FL', '?'), ('RUN1_FLD_CD', 'i4'),
        ...
        ('FLD_ID', 'a8'), ('BASE2_FORCE_FL', '?'), ('BASE3_FORCE_FL', '?'),
        ('BASE4_FORCE_FL', '?'), ('BAT_SAFE_ERR_FL', '?'),
        ...
        ('ASS10_FLD_CD', 'a8'), ('UNKNOWN_OUT_EXC_FL', '?'),
