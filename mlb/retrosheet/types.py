...
def cwevent_dtype():
    ...
    standard_headers = [
        ...
        ('LEADOFF_FL', 'a1'), ('PH_FL', 'a1'), ('BAT_FLD_CD', 'i1'),
        ('BAT_LINEUP_ID', 'i1'), ('EVENT_CD', 'i1'), ('BAT_EVENT_FL', 'a1'),
        ('AB_FL', 'a1'), ('H_FL', 'i1'), ('SH_FL', 'a1'), ('SF_FL', 'a1'),
        ('EVENT_OUTS_CT', 'i1'), ('DP_FL', 'a1'), ('TP_FL', 'a1'),
        ('RBI_CT', 'i1'), ('WP_FL', 'a1'), ('PB_FL', 'a1'), ('FLD_CD', 'i1'),
        ('BATTEDBALL_CD', 'a8'), ('BUNT_FL', 'a1'), ('FOUL_FL', 'a1'),
        ...
        ('RUN2_PLAY_TX', 'a16'), ('RUN3_PLAY_TX', 'a16'), ('RUN1_SB_FL', 'a1'),
        ('RUN2_SB_FL', 'a1'), ('RUN3_SB_FL', 'a1'), ('RUN1_CS_FL', 'a1'),
        ('RUN2_CS_FL', 'a1'), ('RUN3_CS_FL', 'a1'), ('RUN1_PK_FL', 'a1'),
        ('RUN2_PK_FL', 'a1'), ('RUN3_PK_FL', 'a1'), ('RUN1_RESP_PIT_ID', 'a8'),
        ('RUN2_RESP_PIT_ID', 'a8'), ('RUN3_RESP_PIT_ID', 'a8'),
        ('GAME_NEW_FL', 'a1'), ('GAME_END_FL', 'a1'), ('PR_RUN1_FL', 'a1'),
        ('PR_RUN2_FL', 'a1'), ('PR_RUN3_FL', 'a1'),
